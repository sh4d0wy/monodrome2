...
const page = () => {
  return (
    <div className="w-full h-fit flex flex-col items-center justify-center overflow-x-hidden gap-[5rem] ">
      ...
      <div className='flex flex-col  bg-[#252d37] border border-[#192435] hover:border-slate-700 rounded-lg p-[1%] gap-3 w-[90%]'>
        ...
        <div className='text-sm text-slate-400'>Voters earn a share of transaction fees and incentives for helping govern how emissions are distributed.</div>
        <hr className='w-full border border-[#141D28]'/>
        <div className='flex justify-between items-center'>
            <div className='flex text-sm text-slate-400 gap-2 items-center'>
      ...
      <div className='flex flex-col w-[90%] h-full gap-3 px-[1%]'>
        ...
        <div className='flex flex-col gap-1 w-full text-[0.75rem]'>
            ...
            <div className='w-full h-full flex flex-col bg-[#252d37] px-6 py-1'>
              <div className='w-full h-full flex py-2'>
                  <div id="pools" className='flex items-start gap-2 w-[40%]'>
                    <div className='relative flex justify-start'>
                      ...
                      <div className='flex flex-col'>
                          <span className='text-[0.9rem] font-bold'>vAMM-Virtual/Weth</span>
                  ...
                  <div id='fees' className='w-[18%] h-full flex items-center'>
                      <div className=' w-full h-[15vh] bg-[#1E242A] rounded-lg h-full flex flex-col items-end justify-between py-4 px-3'>
                          <span className='h-[30%] text-[0.9rem] text-gray-200'>~$115,248.92</span>
                          <div className='flex flex-col w-full items-end'>
                          <span className='text-[0.65rem] text-gray-400'>391,526.1 VIRTUAL</span>
                          <span className='text-[0.65rem] text-gray-400'>16.69 WETH</span>
                          </div>
                      </div>

                  </div>
                  <div id='Incentives' className='w-[18%] h-full flex items-center'>
                  <div className=' w-full h-[15vh] bg-[#1E242A] rounded-lg h-full flex flex-col items-end justify-between py-4 px-3'>
                          <span className='h-[30%] text-[0.9rem] text-gray-200'>~$115,248.92</span>
                          <div className='flex flex-col w-full items-end'>
                          <span className='text-[0.65rem] text-gray-400'>391,526.1 VIRTUAL</span>
                  ...
                  <div id='Total Rewards'  className='w-[18%] h-full flex items-center'>
                  <div className=' w-full h-[15vh] bg-[#1E242A] rounded-lg h-full flex flex-col items-end justify-between py-4 px-3'>
                          <span className='h-[30%] text-[0.9rem] text-gray-200'>~$115,248.92</span>
                          <div className='flex flex-col w-full items-end'>
                          <span className='text-[0.65rem] text-gray-400'>391,526.1 VIRTUAL</span>
                  ...
                  <div className='w-[30%] flex'>
                  <div id='vAPR' className='w-2/3 h-full flex items-center justify-end'>
                  <span>52.9%</span>
                  </div>
