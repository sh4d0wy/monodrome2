...
const page = () => {
  return (
    ...
    <div className='w-[75%] h-full py-12 text-slate-400 text-[0.9rem] gap-12 flex flex-col'>
            <div id='section1' className='flex flex-col w-full h-full gap-4 '>
                    ...
                    <div className='w-full bg-[#121B2C] py-6 px-6 text-[0.8rem]'>
