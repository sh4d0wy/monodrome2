...
const page=()=>{
    return(
        <div className="w-full h-fit flex px-4 lg:px-12 flex-col items-center justify-center overflow-hidden">
            <div className="w-full h-full flex flex-col lg:flex-row flex items-center justify-center gap-[5vw] mt-[4%] mb-[4%] lg:h-[30rem]">
            <div className='flex flex-col w-[98%] md:w-[80%] lg:w-[40%] gap-[0.5rem] bg-[#252d37] p-[2rem] lg:p-[2%] rounded-xl h-full'>
                <p></p>
                ...
                <div className='flex justify-between w-full text-[#647186]'>
                    <div className='flex flex-col gap-[0.5vw]'>
                        ...
                        <p className='text-md lg:text-lg'><span className='text-[#fffa] '>55,378.64</span> $BIF</p>
                        <p className='text-md lg:text-lg'><span className='text-[#fffa]'>0.00005</span> WETH</p>
                    </div>
                    <div className='flex flex-col gap-[0.5vw]'>
                        <p className='font-light text-sm lg:text-md'>Your Deposits</p>
                        <p className='text-md lg:text-lg'><span className='text-[#fffa]'>0.0</span> $BIF</p>
                        <p className='text-md lg:text-lg'><span className='text-[#fffa]'>0.0</span> WETH</p>
                    </div>
                </div>
                <hr className="h-px my-4 bg-gray-200 border-0 dark:bg-gray-700"></hr>
                <div className='flex justify-between w-full text-[#647186]'>
                    <div className='flex flex-col gap-[0.5vw] items-center justify-center'>
                            ...
                            <p className='text-md lg:text-lg'><span className='text-[#fffa]'>0.0%</span></p>
                    </div>
                    <div className='flex flex-col gap-[0.5vw] items-center justify-center'>
          ...
          <div className='flex flex-col gap-[2vw] bg-gradient-to-t from-[#0F1820] to-[#162C25] w-[98%] md:w-[80%] lg:w-[33%] p-[1.5rem] lg:p-[4vw] rounded-xl h-full'>
            <p className='text-md lg:text-md'>Incentives are usually provided by the
            ...
            <p className='w-full text-md lg:text-md'>By providing an incentive, you may draw more
